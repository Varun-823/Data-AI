...
try:
    ...
    delta_stream = transformed_df.writeStream \
        .format("delta") \
        .outputMode("append") \
        .option("checkpointLocation", "/home/xs521-varver/Desktop/DataAi/data/checkpoints/delta_kafka_consumer") \
        .start("/home/xs521-varver/Desktop/DataAi/data/delta/tables/wind_data")
